...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-63qjrmq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-63qjrmq.containers.anotherwebservice.com/
...
```
git clone git@github.com:TomkoCZ/container-63qjrmq.git
cd container-63qjrmq
```
...
```
docker attach container-63qjrmq
```
